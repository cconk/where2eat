        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OptionContributor = table.Column<string>(nullable: true),
                    OptionDescription = table.Column<string>(nullable: true),
                    OptionName = table.Column<string>(nullable: true),
                    OptionValue = table.Column<decimal>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Options", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Options_Events_EventId",
                        column: x => x.EventId,
